...
request.open('GET', 'js/coords.json', true);
var data 
request.onload = function() {
  if (request.status >= 200 && request.status < 400) {
    // Success!
   data = JSON.parse(request.responseText);
    console.log(data[0].c1);
    console.log(data[0].c2);

    console.log(data[1].c1);
    console.log(data[1].c2);

    console.log(data[2].c1);
    console.log(data[2].c2);

    console.log(data[3].c1);
    console.log(data[3].c2);

    console.log(data[4].c1);
    console.log(data[4].c2);
...
request.send();
            ...
            function listener0 (){
            document.getElementById("indexc1").coords = data[0].c1;
            document.getElementById("indexc2").coords = data[0].c2;
            ...
            function listener1 (){
            document.getElementById("img2_0").coords = data[1].c1;
            document.getElementById("img2_1").coords = data[1].c2;
            ...
            function listener2 (){
            document.getElementById("img3_0").coords = data[2].c1;
            document.getElementById("img3_1").coords = data[2].c2;    
            recall0();
            life();
            document.getElementById("img3").addEventListener("click", minus);    
            }
            function listener3 (){
            document.getElementById("img4_0").coords = data[3].c1;
            document.getElementById("img4_1").coords = data[3].c2;    
            recall0();
            life();
            document.getElementById("img4").addEventListener("click", minus);
            }
            function listener4 (){
            document.getElementById("img5_0").coords = data[4].c1;
            document.getElementById("img5_1").coords = data[4].c2;      
            recall0();
            life();
